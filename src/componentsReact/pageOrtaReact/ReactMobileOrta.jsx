...
import dataReactMobileOrta from '../dataOrtaReact/dataReactMobileOrta';
...
function ReactMobileOrta() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        {dataReactMobileOrta.map((section) => (
          <div key={section.id} className="mb-20">
            ...
            <div className="space-y-8 mb-12">
              <h2 className="text-3xl font-bold text-gray-800 mb-6">
                {section.mainTopics.mobileComponents.title}
              </h2>
              {section.mainTopics.mobileComponents.components.map((component, index) => (
                <ContentCard key={index}>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">
                    {component.name}
                  </h3>
            ...
            <div className="space-y-8 mb-12">
              <h2 className="text-3xl font-bold text-gray-800 mb-6">
                {section.mainTopics.nativeFeatures.title}
              </h2>
              {section.mainTopics.nativeFeatures.features.map((feature, index) => (
                <ContentCard key={index}>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">
                    {feature.name}
                  </h3>
...
export default memo(ReactMobileOrta);