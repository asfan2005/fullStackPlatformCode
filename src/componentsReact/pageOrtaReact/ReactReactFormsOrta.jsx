...
import dataReactFormsOrta from '../dataOrtaReact/dataReactFormsOrta';
...
function ReactReactFormsOrta() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        {dataReactFormsOrta.map((section) => (
          <div key={section.id} className="mb-20">
            ...
            <div className="space-y-8 mb-12">
              <h2 className="text-3xl font-bold text-gray-800 mb-6">
                {section.mainTopics.advancedTopics.title}
              </h2>
              <div className="grid grid-cols-1 gap-8">
                {section.mainTopics.advancedTopics.components.map((component, index) => (
...
export default memo(ReactReactFormsOrta);