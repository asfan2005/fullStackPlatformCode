...
import dataReactSuspenseOrta from '../dataOrtaReact/dataReactSuspenseOrta';
...
function ReactReactSuspenseOrta() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        {dataReactSuspenseOrta.map((section) => (
...
export default memo(ReactReactSuspenseOrta);