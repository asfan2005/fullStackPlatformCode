...
import dataContextApi from '../dataBoshlangichReact/dataContextApi';
        ...
        {dataContextApi.map((data) => (
          <div key={data.id} className="space-y-12">
            ...
            <div className="space-y-8">
              <h2 className="text-3xl font-bold text-gray-800">{data.mainTopics.basicConcepts.title}</h2>
              <div className="grid grid-cols-1 gap-8">
                {data.mainTopics.basicConcepts.concepts.map((concept, index) => (
            ...
            <div className="space-y-8">
              <h2 className="text-3xl font-bold text-gray-800">{data.mainTopics.contextUsage.title}</h2>
              <div className="grid grid-cols-1 gap-8">
                {data.mainTopics.contextUsage.components.map((component, index) => (
                  <div key={index} className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
                    <div className="p-8">
            ...
            <div className="space-y-8">
              <h2 className="text-3xl font-bold text-gray-800">{data.mainTopics.advancedPatterns.title}</h2>
              <div className="grid grid-cols-1 gap-8">
                {data.mainTopics.advancedPatterns.patterns.map((pattern, index) => (
                  <div key={index} className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
                    <div className="p-8">
                      <h3 className="text-2xl font-bold text-gray-800 mb-4">{pattern.name}</h3>
