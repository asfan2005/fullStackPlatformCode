...
import dataPerformanceBoshlangich from '../dataBoshlangichReact/dataPerformanceBoshlangich';
import { Prism as SyntaxHighlighter } from 'react-syntax-highlighter';
import { tomorrow } from 'react-syntax-highlighter/dist/esm/styles/prism';

function ReactPerformanceBosh() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        {dataPerformanceBoshlangich.map((data) => (
          <div key={data.id} className="space-y-12">
            ...
            <div className="space-y-8">
              <h2 className="text-3xl font-bold text-gray-800">{data.mainTopics.optimizationTechniques.title}</h2>
              <div className="grid grid-cols-1 gap-8">
                {data.mainTopics.optimizationTechniques.techniques.map((technique, index) => (
                  <div key={index} className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
                    <div className="p-8">
...
export default ReactPerformanceBosh;