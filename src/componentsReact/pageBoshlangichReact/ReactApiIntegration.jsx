...
import dataApiIntegration from '../dataBoshlangichReact/dataApiIntegration';
import { Prism as SyntaxHighlighter } from 'react-syntax-highlighter';
import { tomorrow } from 'react-syntax-highlighter/dist/esm/styles/prism';

function ReactApiIntegration() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        {dataApiIntegration.map((data) => (
          <div key={data.id} className="space-y-12">
            ...
            <div className="space-y-8">
              <h2 className="text-3xl font-bold text-gray-800">{data.mainTopics.fetchExamples.title}</h2>
              <div className="grid grid-cols-1 gap-8">
                {data.mainTopics.fetchExamples.concepts.map((concept, index) => (
            ...
            {/* Axios Examples Section */}
            <div className="space-y-8">
              <h2 className="text-3xl font-bold text-gray-800">{data.mainTopics.axiosExamples.title}</h2>
              <div className="grid grid-cols-1 gap-8">
                {data.mainTopics.axiosExamples.features.map((feature, index) => (
                  <div key={index} className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
                    <div className="p-8">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 gap-8">
                {data.mainTopics.customHooks.examples.map((example, index) => (
                  <div key={index} className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
                    <div className="p-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300">
              ...
              {data.mainTopics.bestPractices.examples && (
...
export default ReactApiIntegration;