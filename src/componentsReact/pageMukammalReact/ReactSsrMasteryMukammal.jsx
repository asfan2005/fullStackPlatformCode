...
import dataSsrMasteryMukammal from '../dataMukammalReact/dataSsrMasteryMukammal'
import { Prism as SyntaxHighlighter } from 'react-syntax-highlighter'
import { vscDarkPlus } from 'react-syntax-highlighter/dist/esm/styles/prism'
import { toast } from 'react-hot-toast'

function ReactSsrMasteryMukammal() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-8 text-indigo-600">React Server Side Rendering (SSR)</h1>
      
      <div className="flex flex-col gap-8">
        {dataSsrMasteryMukammal.map((item) => (
...
export default ReactSsrMasteryMukammal