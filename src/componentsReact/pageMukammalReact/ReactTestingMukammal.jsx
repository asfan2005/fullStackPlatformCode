...
import dataTestingMukammal from '../dataMukammalReact/dataTestingMukammal'
import { Prism as SyntaxHighlighter } from 'react-syntax-highlighter'
import { vscDarkPlus } from 'react-syntax-highlighter/dist/esm/styles/prism'
import { toast } from 'react-hot-toast'

function ReactTestingMukammal() {
      ...
      return (
        <div className="space-y-2">
          ...
          <div className="space-y-1">
            ...
            {Object.entries(parsedResult.output).map(([testName, result]) => (
              <p key={testName} className="text-green-600">{result}</p>
            ))}
          </div>
        </div>
      )
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-8 text-indigo-600">React Testing Tutorials</h1>
      
      <div className="flex flex-col gap-8">
        {dataTestingMukammal.map((item) => (
...
export default ReactTestingMukammal