...
import dataProgressiveWebMukammal from '../dataMukammalReact/dataProgressiveWebMukammal'
import { Prism as SyntaxHighlighter } from 'react-syntax-highlighter'
import { vscDarkPlus } from 'react-syntax-highlighter/dist/esm/styles/prism'
import { toast } from 'react-hot-toast'

function ReactPrognessiveWebMukammal() {
            ...
            <ul className="list-disc pl-5 mt-1">
              {parsedResult.benefits ? 
                ...
                parsedResult.properties ? 
                  parsedResult.properties.map((property, index) => (
                    <li key={index}>{property}</li>
                  )) :
                parsedResult.technologies ? 
                  parsedResult.technologies.map((tech, index) => (
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-8 text-indigo-600">Progressive Web App</h1>
      
      <div className="flex flex-col gap-8">
        {dataProgressiveWebMukammal.map((item) => (
...
export default ReactPrognessiveWebMukammal