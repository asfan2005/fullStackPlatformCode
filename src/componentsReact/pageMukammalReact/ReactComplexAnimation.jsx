...
import dataComplexAnimation from '../dataMukammalReact/dataComplexAnimation'
import { Prism as SyntaxHighlighter } from 'react-syntax-highlighter'
import { vscDarkPlus } from 'react-syntax-highlighter/dist/esm/styles/prism'
import { toast } from 'react-hot-toast'

function ReactComplexAnimation() {
    ...
    try {
      ...
      return (
        <div className="space-y-2">
          <div>
            <strong>Animation:</strong> {parsedResult.animation}
          </div>
          <div>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-8 text-indigo-600">React Complex Animations</h1>
      
      <div className="flex flex-col gap-8">
        {dataComplexAnimation.map((item) => (
...
export default ReactComplexAnimation