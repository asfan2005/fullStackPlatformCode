...
import dataReactPerformanceMukammal from '../dataMukammalReact/dataReactPerformanceMukammal'
import { Prism as SyntaxHighlighter } from 'react-syntax-highlighter'
import { vscDarkPlus } from 'react-syntax-highlighter/dist/esm/styles/prism'
import { toast } from 'react-hot-toast'

function ReactPerformanceMukammal() {
          ...
          <div>
            <ul className="list-disc pl-5 mt-1">
              {parsedResult.benefits ? 
                ...
                parsedResult.techniques ? 
                  parsedResult.techniques.map((technique, index) => (
                    <li key={index}>{technique}</li>
                  )) :
                parsedResult.metrics.map((metric, index) => (
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-8 text-indigo-600">React Performance</h1>
      
      <div className="flex flex-col gap-8">
        {dataReactPerformanceMukammal.map((item) => (
...
export default ReactPerformanceMukammal