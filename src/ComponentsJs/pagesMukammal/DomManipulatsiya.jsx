...
import dataModullar from '../dataMukammal/dataDomManipulyatsiya';
import { Prism as SyntaxHighlighter } from 'react-syntax-highlighter';
import { tomorrow } from 'react-syntax-highlighter/dist/esm/styles/prism';


function DomManipulatsiya() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-12 text-center text-gray-600">
          ...
          <div className="mt-4 flex justify-center space-x-4">
            <a 
              href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/dom_manipulation" 
              target="_blank"
...
export default DomManipulatsiya;