...
import practiceDataBoolean from '../data/dataGoodConstraction';

function GoodConstraction({ handleSubLessonComplete, activeLesson, activeSubLesson }) {
...
export default GoodConstraction;