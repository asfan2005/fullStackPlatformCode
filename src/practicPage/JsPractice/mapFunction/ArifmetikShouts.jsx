...
import practiceDataArifmetik from '../data/dataArifmetikShouts';

function ArifmetikShouts({ handleSubLessonComplete, activeLesson, activeSubLesson }) {
...
export default ArifmetikShouts;