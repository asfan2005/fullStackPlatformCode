...
import dataCustomization from '../dataMukammal/dataCustomization';
                ...
                <div className="p-8">
                  ...
                  >
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed">
                      {item.description || "Bu bo'lim haqida qo'shimcha ma'lumot tez orada qo'shiladi."}
                    </p>
                  </motion.div>
                </div>
              </motion.div>
